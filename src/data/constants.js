...
// 초기 화면 '대안 문장 글자수' 콤보박스 선택지.
// 기본값은 'best'(최선의 문장) — 아무것도 바꾸지 않으면 기존과 동일하게 동작한다.
// 교사 친화적으로 "자(한글 글자수)" 기준으로 표시한다.
export const REWRITE_LENGTH_OPTIONS = [
  { value: '300',  label: '300자 내외 (250~350자)' },
  { value: '400',  label: '400자 내외 (350~450자)' },
  { value: '500',  label: '500자 내외 (450~500자)' },
  { value: 'best', label: '최선의 문장 (글자수 제한 없음)' },
];

// 글자수 선택 시 권장(목표) 글자수 범위 [min, max] — RewriteCard 게이지·판정에 사용.
// 500은 NEIS 한도(약 500자)를 넘지 않도록 상한을 500으로 둔다.
export const REWRITE_LENGTH_RANGES = {
  '300': [250, 350],
  '400': [350, 450],
  '500': [450, 500],
};
